...
In javascript, we can't get the user's real code, we can only get the system compiled code.
...
sc=(o)=>{if (typeof o!=='object') o=(o+'').split('');return o+''===o.reverse()+'';}

//or

sc=(o)=>{if(!Array.isArray(o))o=(o+'').split('');return o.join()==o.reverse().join()}