...
/*
John wants to decorate a room with wallpaper. He's heard that making sure he has the right amount of wallpaper
is more complex than it sounds. He wants a fool-proof method for getting it right.
...
function wallpaper(l, w, h) {
  ...
  return w * h * l === 0 ? dict[0]
    : dict[Math.ceil(((l * h * 2 + w * h * 2) * 1.15) / 5.2)];
}
