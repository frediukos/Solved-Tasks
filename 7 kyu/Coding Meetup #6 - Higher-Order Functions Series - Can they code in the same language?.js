...
The strings representing a given language will always be formatted in the same way (e.g. 'JavaScript' will always
be formatted will upper-case 'J' and 'S'
...
function isSameLanguage(list) {
  let compare = list[0].language;
  for (let i = 1; i < list.length; i++) {
    if (list[i].language !== compare) return false;
  }
  return true;
}
